...
<!-- jQuery -->
<script src="<?php echo $comp?>../../plugins/jquery/jquery.min.js"></script>
<!-- Bootstrap 4 -->
<script src="<?php echo $comp?>../../plugins/bootstrap/js/bootstrap.bundle.min.js"></script>
<!-- AdminLTE App -->
<script src="<?php echo $comp?>../../dist/js/adminlte.min.js"></script>
...
<script src="<?php echo $comp?>../assets/js/scripts.js"></script> <!--SCRIPT PERSONALIZADOS-->
